...
class DynamicMCPManager:
    ...
    async def get_or_create_client(self, server_id: str, user_id: str, model_name: str = "openai:gpt-4.1", system_prompt: str = None) -> Optional[MCPClient]:
...
async def initialize_default_servers(manager: DynamicMCPManager):
    ...
    if not manager.get_all_servers():
        ...
        await manager.add_server("playwright", {
        ...
        await manager.add_server("apollo", {
